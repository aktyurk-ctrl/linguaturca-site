  ...
  const features = [
    {
      ...
      description: "Все преподаватели — выпускники турецких университетов с высшим образованием в области турецкого языка и лингвистики.",
    },
    {
      icon: "💬",
    ...
    },
    {
      ...
      description: "Учим не только язык, но и культуру Турции — через реальные истории, менталитет и традиции.",
    },
  ];
